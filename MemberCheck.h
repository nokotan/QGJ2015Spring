...
class CheckMember : public CheckMember<Type, void> {
	CreateTestMember(TestOnCollideFromSide,		obj.OnCollideFromSide(std::declval<ArgType>()));
	CreateTestMember(TestOnCollideFromBottom,	obj.OnCollideFromBottom(std::declval<ArgType>()));
...
struct OnCollideFromSideCaller {
	static void OnCollideFromSide(Type& obj, MapType& tile) {
		obj.OnCollideFromSide(tile);
	}
};
...
struct OnCollideFromBottomCaller {
	static void OnCollideFromBottom(Type& obj, MapType& tile) {
		obj.OnCollideFromBottom(tile);
	}
};
